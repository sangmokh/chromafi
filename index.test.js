...
// Skip highlight test since the feature is removed by the removal of ansi-mark
...
test('Circular JSON throws', t => {
	...
	t.is(error.message.startsWith('TypeError: 🦅  Chromafi: Converting circular structure to JSON'), true)
})
...
// Fails due to change in highlight.js behavior
// test('Diff', t => {
